...
public class CommonMethods {
	 ...
	 * @param textToSelect
	 */
	public static void selectDropDowndByValue(WebElement element, String textToSelect) {
		try {
	 ...
	 * @param index
	 */
	public static void selectDropDowndByIndex(WebElement element, int index) {
		try {
			Select select = new Select(element);
